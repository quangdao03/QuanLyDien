...
public class frmMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mnuNguoiDung = new javax.swing.JMenuItem();
        ...
        lbl_chuchay.setForeground(new java.awt.Color(122, 122, 243));
        lbl_chuchay.setText("PHẦN MỀM QUẢN LÝ ĐIỆN SỐ 1 VIỆT NAM");
        ...
        Desktop.setLayer(lbl_chuchay, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        mnuNguoiDung.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_U, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        mnuNguoiDung.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_user_24px.png"))); // NOI18N
        mnuNguoiDung.setText("Quản Lý Người Dùng");
        mnuNguoiDung.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuNguoiDungActionPerformed(evt);
            }
        });
        mnuHeThong.add(mnuNguoiDung);
        ...
        mnuTaiKhoan.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_K, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        mnuTaiKhoan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Hinh/icons8_user_folder_24px.png"))); // NOI18N
        mnuTaiKhoan.setText("Quản Lý Tài Khoản");
        mnuTaiKhoan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuTaiKhoanActionPerformed(evt);
            }
        });
        mnuHeThong.add(mnuTaiKhoan);
    ...
    private void mnuNguoiDungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuNguoiDungActionPerformed
        QuanLyNhanVien frm = new QuanLyNhanVien();
        Desktop.add(frm);
        frm.setVisible(true);
        Main.playSound("soundbutton.wav");
    }//GEN-LAST:event_mnuNguoiDungActionPerformed
...
//        frm.setLocation((Desktop.getWidth()-frm.getWidth())/2,(Desktop.getHeight()-frm.getHeight())/2);
    ...
    private javax.swing.JMenuItem mnuNguoiDung;
